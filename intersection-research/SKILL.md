...
**Gate type:** G-intersection-brief (closing gate — Check 6 KCA applies).
**Fires after:** Brief authoring, before closing.
...
Gate type: G-intersection-brief
...
Task instruction: Read the gate-type registry entry for G-intersection-brief. Run Check 1 satisfaction targets.
