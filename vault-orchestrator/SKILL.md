...
**Skip if:** peer-reviewer skill not available on this substrate (graceful degradation; log warning to event log per the 5-field format in `gate-peer-reviewer/SKILL.md` § Graceful degradation).
