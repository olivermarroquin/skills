...
**Gate type:** G-city-brief (closing gate — Check 6 KCA applies).
**Fires after:** Jurisdiction anomaly check + brief authoring, before closing.
...
Task instruction: Read the gate-type registry entry for G-city-brief. Run Check 1 satisfaction targets
